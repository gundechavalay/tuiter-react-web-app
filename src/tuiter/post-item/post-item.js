  ...
  <li className="list-group-item">
      <div className="row">
        <div className="col-1 mt-1 mb-1 me-2">
          <img className="rounded-circle" height={48} width={48} src={`/images/${post.image}`} alt="side-icon"/>
        </div>
        ...
        <div className="col-12 ps-5">
          <div>{post.title}</div>
          <div className="mt-2 mb-2"><img style={imageBorder} height={'80%'} width={'90%'} src={`/images/${post.image}`} alt="side-icon"/></div>
        </div>
        <div className="ps-5">
